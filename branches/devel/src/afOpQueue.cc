...
void opQueue::dump() {
  ...
  r = sqlite3_prepare_v2(db, "SELECT rank,status,main_url,n_failures FROM queue WHERE 1 ORDER BY rank ASC",
    -1, &comp_query, NULL);
...
/** Change status queue. Returns true on success, false if update failed.
 */
